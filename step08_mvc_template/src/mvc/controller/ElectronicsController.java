...
public class ElectronicsController {
    ...
    public void selectAll() {
    	...
    	SuccessView.printAll(electronicsList);
    }
    ...
    public void update(Electronics electronics) {
    	try {
			...
			SuccessView.printMessage("업데이트에 성공하였습니다.");
		} catch (Exception e) {
			FailView.errorMessage(e.getMessage());
		}
    }
    ...
    public void discountModelNo(int modelNo, int discountPercent) {
    	try {
    		service.updateDiscount(modelNo, discountPercent);
    		SuccessView.printMessage("할인 적용에 성공하셨습니다.");
		} catch (Exception e) {
			FailView.errorMessage(e.getMessage());
		}
    }
    
    public void searchModelName(String modelName) {
    	try {
    		SuccessView.printAll(service.searchModelName(modelName));
		} catch (Exception e) {
			FailView.errorMessage(e.getMessage());
		}
    }
