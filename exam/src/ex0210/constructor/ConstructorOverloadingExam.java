...
public class ConstructorOverloadingExam{
		...
		public static void main(String [] args){
			...
			Puppy3[] puppies = new Puppy3[5];
			
			
			puppies[0] = new Puppy3();
			puppies[1] = new Puppy3("나비");
			puppies[2] = new Puppy3("김", "철수");
			puppies[3] = new Puppy3(true);
			puppies[4] = new Puppy3('3');
			
				
		//각 객체의 printMemberVariable메소드를 한번씩 호출
		for (Puppy3 puppy3 : puppies) {
