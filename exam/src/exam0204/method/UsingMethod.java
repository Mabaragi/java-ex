...
class UsingMethodExam{
	...
	인수로 받은 정수 출력 
	정수*2 리턴. */
	private int methodExam03_01(int par) {
	...
	*/
	public String methodExam03_02(String par1, int par2) {
		String resultString = par1 + "바보";
		System.out.println(resultString);
		System.out.println(par1 + "바보");
		int result = this.methodExam03_01(par2);
     ...
     (구현부에서)하는 일 : 
		...
		methodExam03_02호출
	*/	
	void methodExam03_03(int par1, String par2) {
		System.out.println("methodExam03_03이 호출되었습니다.");
		this.methodExam03_02(par2, par1);
	}
	...
	*/	
	protected double methodExam03_04(int par1, double par2, int par3) {
		System.out.println("methodExam03_04가 호출되었습니다.");
		MakeMethodExam02 methodObject = new MakeMethodExam02();
		double result = methodObject.methodExam02_04(par1, par2, par3);
		return result;
	}
...
class UsingMethod{
	...
	public static void main(String[] args) {
		UsingMethodExam methodObject = new UsingMethodExam();
		System.out.println(methodObject.methodExam03_02("Java", 3));
		methodObject.methodExam03_03(4, "python");
		System.out.println(methodObject.methodExam03_04(3, 4.1, 2));
	}
