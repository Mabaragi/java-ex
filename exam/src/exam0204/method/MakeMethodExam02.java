...
/*	
	...
	(구현부에서)하는일 : 인수로 받은(들어온) 두개의 정수의 합을 출력하고
		...
		두정수의 합 리턴
*/
	private int methodExam02_01(int val1, int val2) {
		int sum = val1 + val2;
		System.out.println(String.format("두 정수의 합: %d", sum));
		if (sum%3==0) {
...
*/
	public String methodExam02_02(String val) {
		String result = val + "바보";
		return result;
	}
/*	
...
*/
	void methodExam02_03(int val1, String val2) {
		System.out.println(Integer.toString(val1) + val2);
		if (val1%4==0)System.out.println(1); else System.out.println(0);
	}
/*	
	...
	(구현부에서)하는일 : 첫번째 인수 곱하기 두번째인수 빼기 세번째인수 결과 출력
			     위의 결과를 리턴
*/
	protected double methodExam02_04(int val1, double val2, int val3) {
