...
class SubClass extends SuperClass{
	...
	@Override
	public void methodZero(){ // 서브클래스의 접근제한자는 부모클래스의 접근제한자보다 작을수 없다.
	...
	protected void methodOwn(){ // 서브클래스의 접근제한자는 부모클래스의 접근제한자보다 작을수 없다. / 반환 타입이  같아야한다
		
		System.out.println("SubClass객체의 methodOwn()메소드가 호출되었습니다.");
 		System.out.println("intNumber="+intNumber+"\t"+"memberString="+memberString); 
 	}
 	
	int methodTwo(int a){ // 서브클래스의 접근제한자는 부모클래스의 접근제한자보다 작을수 없다. / 반환 타입이  같아야한다
	...
	String methodThree(String str, int k){
